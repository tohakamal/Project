...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_EVENTS_TABLE = "create table "+DBStructure.EVENT_TABLE+"(ID INTEGER PRIMARY KEY AUTOINCREMENT, "
    ...
    private static final String DROP_EVENTS_TABLE = "DROP TABLE IF EXISTS "+DBStructure.EVENT_TABLE;
    ...
    public Cursor ReadEvents(String date,SQLiteDatabase database){
        ...
        return database.query(DBStructure.EVENT_TABLE,Projections,Selection,SelectionArgs,null,null,null);
    }
    ...
    public void deleteEvent(String event,String data,String time,SQLiteDatabase database){

        String selection = DBStructure.EVENT+"=? and  "+DBStructure.DATE+"=? and "+DBStructure.TIME+"=?";
        String[] selectionArg ={event,data,time};
    ...
    public void updateEvent(String date,String event,String time,String notify,SQLiteDatabase database){
        ...
        String Selection = DBStructure.DATE +"=? and "+DBStructure.EVENT+"=? and "+DBStructure.TIME+"=?";
        String [] SelectionArgs = {date,event,time};
        database.update(DBStructure.EVENT_TABLE,contentValues,Selection,SelectionArgs);
    }
